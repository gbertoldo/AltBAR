...
## Onde comprar?
Os arquivos de produção do AltBAR e da placa adaptadora (Gerber, BOM, Pick and place) estão disponíveis publicamente, de modo que qualquer pessoa poderá solicitar o altímetro pronto em sites como PCBWay ou JLCPCB. O cabo JST-GH e o Gravador AVR USB-ASP podem ser encontrados em diversas lojas online.
